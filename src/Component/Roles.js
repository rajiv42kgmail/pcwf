...
<div className="form-check">
  <input className="form-check-input" type="checkbox" name="roles" value="createPages" id="createPage"  onChange={handleChange}/>
  <label className="form-check-label" for="createPage">
    Create Pages
  </label>
  </div>
  <div className="form-check">
  <input className="form-check-input" type="checkbox" name="roles" value="editPages" id="editPage" onChange={handleChange} />
  ...
  <input className="form-check-input" type="checkbox" name="roles" value="deletePages" id="delPage" onChange={handleChange} />
...
<div className="form-check">
  <input className="form-check-input" type="radio" name="rolesuser" id="VeracodeUser" value="vcodeuser" onChange={handleChange}/>
  <label className="form-check-label" for="VeracodeUser">
    Veracode User
  </label>
</div>
<div className="form-check">
  <input className="form-check-input" type="radio" name="rolesuser" id="admin" value="admin" onChange={handleChange} checked />
